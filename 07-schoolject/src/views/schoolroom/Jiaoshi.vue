    ...
    <div class="in" >
        ...
        <div v-if="isShow">
            ...
            <el-form ref="xiugai" :model="xiugai" :rules="rules">
                <el-form-item label="年级" width="120px" maxlength="3" prop="nianji">
                    <el-input v-model="xiugai.nianji" placeholder="请输入年级" clearable style="width: 280px"/>
                </el-form-item>
                <el-form-item label="班级" width="120px" maxlength="3" prop="banji">
                ...
                <el-form-item label="教室" width="120px" maxlength="3" prop="jiaoshi">
                    <el-input v-model="xiugai.jiaoshi" placeholder="请输入教室" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
            <template #footer>
            ...
            <el-dialog v-model="isShows" title="添加教室">
                <el-form ref="xiugais" :model="xiugais" :rules="rules">
                    ...
                    <el-form-item label="教室" width="120px" prop="jiaoshis">
                        <el-input v-model.number="xiugais.jiaoshis" placeholder="请输入教室"  maxlength="3" autocomplete="off"></el-input>
                    </el-form-item>
                </el-form>
                <template #footer>
      <span class="dialog-footer">
