            ...
            <el-dialog v-model="isShow" title="修改班级">
                <el-form ref="xiugai" :model="xiugai" :rules="rules">
                    <el-form-item label="年级" width="120px" prop="nianji">
                        <el-input v-model="xiugai.nianji" maxlength="10" placeholder="请输入查年级" clearable style="width: 280px"/>
                    </el-form-item>
                    <el-form-item label="班级" width="120px" prop="banji">
                        <el-input v-model="xiugai.banji" maxlength="10" placeholder="请输入查班级" clearable style="width: 280px"/>
                    </el-form-item>
                    <el-form-item label="教室" width="120px" prop="jiaoshi">
                        <el-input v-model="xiugai.jiaoshi" maxlength="3" autocomplete="off"></el-input>
                    </el-form-item>
                </el-form>
                <template #footer>
            ...
            <el-dialog v-model="isShows" title="添加班级">
                <el-form  ref="xiugais" :model="xiugais" :rules="rules">
                    ...
                    <el-form-item label="教室" width="120px" prop="jiaoshis">
                        <el-input v-model="xiugais.jiaoshis" maxlength="3" autocomplete="off"></el-input>
                    </el-form-item>
                </el-form>
                <template #footer>
      <span class="dialog-footer">
